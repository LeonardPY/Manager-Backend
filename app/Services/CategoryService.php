...
readonly class CategoryService
{
    ...
    public function uploadStoreCategoryPictures(array $data, ?int $categoryId = null): array
    {
        ...
        if (isset($data['picture'])) {
            $data['picture'] = $this->pictureService->uploadPicture($data['picture'], PicturesPathEnum::CATEGORY_PICTURES->value. '/'. $categoryId . PicturesPathEnum::CATEGORY_IMAGE->value);
        }
        if (isset($data['banner_picture'])) {
            $data['banner_picture'] = $this->pictureService->uploadPicture($data['banner_picture'], PicturesPathEnum::CATEGORY_PICTURES->value. '/'. $categoryId . PicturesPathEnum::CATEGORY_BANNER->value);
        }
        return $data;
    }
